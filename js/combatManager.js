class CombatManager {
    ...
    processAttack() {
        ...
        logToConsole(logMsg, attacker === this.gameState ? 'lightblue' : 'gold');
        ...
        if (defender) {
            ...
            if (defenderDefenseTypeToUse !== "None") {
                ...
                logToConsole(defenseLogMsg, defender === this.gameState ? 'lightblue' : 'gold');
    ...
    processGrapple() {
        ...
        logToConsole(`GRAPPLE: ${attackerDisplayName} attempts grapple. Roll: ${attackerRoll} (Nat: ${attackerRollNatural}, Unarmed Skill: ${attackerUnarmedSkill})`, attacker === this.gameState ? 'lightblue' : 'gold');
        logToConsole(`GRAPPLE DEFENSE: ${defenderDisplayName} resists. Roll: ${defenderRoll} (Nat: ${defenderRollNatural}, Unarmed Skill: ${defenderUnarmedSkill})`, defender === this.gameState ? 'lightblue' : 'gold');
