...
const gameState = {
    ...
    stats: [
        ...
        { name: "Charisma", points: 3, bgColor: "#FF00FF", textColor: "black" }
    ],
    skills: [
        { name: "Animal Handling", points: 0, bgColor: "#FF00FF", textColor: "black" },
        ...
        { name: "Intimidation", points: 0, bgColor: "#FF00FF", textColor: "black" },
        ...
        { name: "Persuasion", points: 0, bgColor: "#FF00FF", textColor: "black" },
